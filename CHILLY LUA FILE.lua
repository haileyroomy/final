...
local ThemeManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/PATRICKPUB/chilly.cc-themes/main/chilly.cc%20themes"))()
...
ArmVisTab:AddToggle('ArmChams', { Text = 'enabled', Default = false }):AddColorPicker('ArmChamsColor', { Default = Color3.fromRGB(24, 62, 250), Title = 'Color' }):OnChanged(function(Value)
if Value == true then
elseif Value == false then
setArmProperties("Color", Color3.fromRGB(24, 62, 250))
...
local Esp = {
	Settings = {
		Boxes = false,
		BoxesOutline = true,
		BoxesColor = Color3.fromRGB(24, 62, 250),
		BoxesOutlineColor = Color3.fromRGB(0, 0, 0),
		Sleeping = false,
		SleepingColor = Color3.fromRGB(24, 62, 250),
		Distances = false,
		DistanceColor = Color3.fromRGB(24, 62, 250),
		Armour = false,
		ArmourColor = Color3.fromRGB(24, 62, 250),
		Tool = false,
		ToolColor = Color3.fromRGB(255,128,114),
		Tracer = false,
		TracerColor = Color3.fromRGB(24, 62, 250),
		TracerThickness = 1,
		TracerTransparrency = 1,
		TracerFrom = "Bottom",
		ViewAngle = false,
		ViewAngleColor = Color3.fromRGB(24, 62, 250),
		ViewAngleThickness = 1,
		ViewAngleTransparrency = 1,
		OreDistances = false,
		OreDistanceColor = Color3.fromRGB(24, 62, 250),
		OreNames = false,
		OreNamesColor = Color3.fromRGB(24, 62, 250),
...
local Fov = {Settings={
    FovEnabled=true,
    FovColor=Color3.fromRGB(24, 62, 250),
    FovSize=90,
    FovFilled=false,
    FovTransparency=1,
    ...
    FovPosition="Screen",
    Snapline=true,
    SnaplineColor=Color3.fromRGB(24, 62, 250)
  }}
      ...
      if Character and Character:FindFirstChild("HumanoidRootPart") and Character:FindFirstChild("Head") and Character.Parent == game.Workspace then
        ...
        if OnScreen == true and Esp.Settings.Boxes == true and Distance <= Esp.Settings.RenderDistance then
          ...
          if IsVisible == true then
            v.Box.Color = Color3.fromRGB(24, 62, 250);v.BoxOutline.Color=Esp.Settings.BoxesOutlineColor;v.BoxFilled.Color=Color3.fromRGB(0,0,0)
          else
        ...
        if OnScreen == true and Esp.Settings.CornerBoxes == true and Distance <= Esp.Settings.RenderDistance then
          ...
          v.BoxFilled.Transparency = Esp.Settings.BoxesFilledTransparency
          if IsVisible == true then
            v.Line1.Color=Color3.fromRGB(24, 62, 250);v.Line2.Color=Color3.fromRGB(24, 62, 250);v.Line3.Color=Color3.fromRGB(24, 62, 250);v.Line4.Color=Color3.fromRGB(24, 62, 250);v.Line5.Color=Color3.fromRGB(24, 62, 250);v.Line6.Color=Color3.fromRGB(24, 62, 250);v.Line7.Color=Color3.fromRGB(24, 62, 250);v.Line8.Color=Color3.fromRGB(24, 62, 250)
            v.BoxFilled.Color=Color3.fromRGB(24, 62, 250)
          else
...
SilentTab:AddToggle('HighlightTarget',{Text='highlight target',Default=false}):AddColorPicker('HighlightTargetColor',{Default=Color3.fromRGB(24, 62, 250),Title='Color'}):OnChanged(function(value)
...
SilentTab:AddToggle('Snapline',{Text='snaplines',Default=false}):AddColorPicker('SnaplineColor',{Default=Color3.fromRGB(24, 62, 250),Title='Color'})
SilentTab:AddToggle('Snapcircles',{Text='snapcircles',Default=false}):AddColorPicker('SnapcirclesColor',{Default=Color3.fromRGB(24, 62, 250),Title='Color'}):OnChanged(function(Value)
...
FovTab:AddToggle('Fov',{Text='enabled',Default=false}):AddColorPicker('FovColor',{Default=Color3.fromRGB(24, 62, 250),Title='Color'})
FovTab:AddToggle('Dynamic',{Text='dynamic',Default=true})
FovTab:AddToggle('FovHighlight',{Text='highlight',Default=false}):AddColorPicker('FovHighlightColor',{Default=Color3.fromRGB(24, 62, 250),Title='Color'})
...
if Functions:GetClosest() ~= nil and Toggles.FovHighlight.Value == true then
  ...
  if Fov.Settings.FovHighlight == true and Functions:GetClosest().Head.Teamtag.Enabled == false and OnScreen == true then
    ...
    FovCircle.Color=Color3.fromRGB(24, 62, 250)
  end
else
  FovCircle.Color = Fov.Settings.FovColor
end
...
PlayerVisualTab:AddToggle("Boxes", { Text = "Boxes", Default = false })
	:AddColorPicker("BoxesColor", { Default = Color3.fromRGB(24, 62, 250), Title = "Color" })
...
PlayerVisualTab:AddToggle("Sleeping", { Text = "Sleeping", Default = false })
	:AddColorPicker("SleepingColor", { Default = Color3.fromRGB(24, 62, 250), Title = "Color" })
PlayerVisualTab:AddToggle("Distances", { Text = "Distance", Default = false })
	:AddColorPicker("DistancesColor", { Default = Color3.fromRGB(24, 62, 250), Title = "Color" })
PlayerVisualTab:AddToggle("Armour", { Text = "Armour", Default = false })
	:AddColorPicker("ArmourColor", { Default = Color3.fromRGB(24, 62, 250), Title = "Color" })
PlayerVisualTab:AddToggle("Tool", { Text = "Tool", Default = false })
	:AddColorPicker("ToolColor", { Default = Color3.fromRGB(24, 62, 250), Title = "Color" })
PlayerVisualTab:AddToggle("ViewAngle", { Text = "View Angle", Default = false })
	:AddColorPicker("ViewAngleColor", { Default = Color3.fromRGB(24, 62, 250), Title = "Color" })
PlayerVisualTab:AddToggle("Tracer", { Text = "Tracer", Default = false })
	:AddColorPicker("TracerColor", { Default = Color3.fromRGB(24, 62, 250), Title = "Color" })
...
local Chats = {
["🌶️Chilly.cc🌶️"] = {"get skill and buy  🌶️Chilly.cc🌶️"};
}
...
RightGroupBox:AddLabel('B4nger/Cyyenvi')


local RightGroupBox = Tabs.Credits:AddLeftGroupbox('CREDIT')
RightGroupBox:AddLabel('🌶️ChillyDreams/dizzy🌶️')

local RightGroupBox = Tabs.Credits:AddLeftGroupbox('BEST CODER')
RightGroupBox:AddLabel('🌶️B4nger/Maybe "Dizzy"🌶️')




local RightGroupBox = Tabs.Credits:AddRightGroupbox('Cyyenvis skill')
RightGroupBox:AddLabel('30000/100')
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(("🌶️Chilly.cc🌶️ | Build: PAID | Game: Trident Survival"):format(
        math.floor(FPS),
...
MenuGroup:AddLabel('Made by b4nger/Cyyenvi', true)
...
ThemeManager:SetFolder('🌶️Chilly.cc🌶️')
SaveManager:SetFolder('🌶️Chilly.cc🌶️/TRIDENT SURVIVAL')
...
wait(0)Library:Notify("Thanks for using 🌶️Chilly.cc🌶️")
wait(0)Library:Notify("Status : 🟢detected")



loadstring(game:HttpGet("https://pastebin.com/raw/uzbP7Me0", true))();
